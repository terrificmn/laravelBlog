...
<div class="w-4/5 m-auto pt-10">
    <form
        ...
        @method('PATCH')
        {{-- {{ dd($portfolio->title)}} --}}
        <input type="text" name="title" value="{{ $portfolio->title }}" class="bg-transparent block border-b-2 w-full h-17 text-xl ouline-none">
        ...
        <textarea
            name="description"
            class="py-5 bg-transparent block border-b-2 w-full h-60 text-l outlilne-none">{{ $portfolio->description }} </textarea>
        ...
        @else
            <div>
                {{-- <p class="w-1/5 mb-4 text-yellow-600 rounded-2xl py-4 pl-2"> --}}
                    ...
                    class="py-5 bg-transparent block border-b-2 w-full h-80 text-l leading-relaxed outlilne-none">{{ $portfolio->convertedMd }}
                    </textarea>
                {{-- </p> --}}
            </div>
            <div class="bg-gray-lighter pt-5">
            ...
            <div>
                ...
                <div class="bg-gray-lighter pt-5">
                    <label class="w-44 flex flex-col itmes-center px-2 py-3 bg-white-rounded-lg shadow-lg tracking-wide uppercase border-2 border-indigo-400 hover:border-indigo-800 cursor-pointer">
                        ...
                        <input type="file" name="reimage" class="hidden">
                </div> 
        ...
        @else
            <div>
                ...
                <input type="text" class="hidden" name="uploaded_image_path" value="{{$portfolio->image_path}}">
