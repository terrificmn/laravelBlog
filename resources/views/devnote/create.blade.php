...
@section('scripts')
    <script>
        ...
        //     .replace('note-textarea', {
        //         filebrowserUploadUrl: "{{route('devnote.imgupload', ['_token' => csrf_token() ])}}",
        ...
        class MyUploadAdapter {
            constructor(loader) {
                ...
                this.url = '{{ route('devnote.imgupload') }}';
        ...
        ClassicEditor.create(document.querySelector("#note-textarea"), {
