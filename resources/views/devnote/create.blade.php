...
<div class="w-4/5 m-auto pt-20">
    <form
        ...
        <textarea
            ...
            id="note-textarea"
            class="py-5 bg-transparent block border-b-2 w-full h-80 text-l outlilne-none"></textarea>

        <div class="bg-gray-lighter py-10">
            <label class="w-44 flex flex-col items-center px-2 py-2 bg-white-rounded-lg shadow-lg tracking-wide uppercase border-2 border-indigo-400 hover:border-indigo-800 cursor-pointer">
        ...
        <div class="pt-10">
            ...
            <input type="text" name="tag" placeholder="tag..." class="bg-transparent block border-b-2 w-full h-10 py-5 text-l ouline-none">
        </div>
