    ...
    <div class="flex flex-no-wrap">
        ...
        <div style="min-height: 716px" class="w-64 absolute sm:relative bg-yellow-300 dark:bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
            <div class="px-8">
                ...
                <ul class="mt-12">
                    <li class="flex w-full justify-between text-gray-800 hover:text-gray-500 cursor-pointer items-center mb-6">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                            ...
                            <span class="text-sm ml-2">Posts-category</span>
                        </a>
                        <div class="py-1 px-3 bg-gray-600 rounded text-gray-300 flex items-center justify-center text-xs">5</div>
                    </li>
                    @foreach($postCategories as $postCategory)
                    <li class="flex w-full justify-between text-gray-800 hover:text-gray-500 cursor-pointer items-center mb-6">
                        <a href=""><span class="text-sm ml-2">{{ $postCategory->category }}</span></a>
                        <div class="py-1 px-3 bg-gray-600 rounded text-gray-300 flex items-center justify-center text-xs">{{ $postCategory->total }}</div>
                    </li>
                    @endforeach
                    ...
                    <li class="flex w-full justify-between text-gray-800 hover:text-gray-500 cursor-pointer items-center mb-6">
                        <a href=""><span class="text-sm ml-2">example</span></a>
                        <div class="py-1 px-3 bg-gray-600 rounded text-gray-300 flex items-center justify-center text-xs">10</div>
                    </li>
                ...
                <div class="flex justify-center mt-48 mb-4 w-full">
                    <div class="relative">
                        ...
                        <input class="focus:outline-none focus:ring-1 focus:ring-gray-100 rounded w-full text-sm text-gray-300 placeholder-gray-400 bg-gray-600 pl-10 py-2" type="text" placeholder="Search" />
                    </div>
                </div>
            </div>
        ...
        <div class="w-64 z-40 absolute dark:bg-gray-800 bg-yellow-300 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
            <button aria-label="toggle sidebar" id="openSideBar" class="h-10 w-10 dark:bg-gray-800 bg-yellow-300 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded focus:ring-gray-800" onclick="sidebarHandler(true)">
                <svg  xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-adjustments" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
