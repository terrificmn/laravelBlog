    ...
    <div class="flex flex-no-wrap">
                ...
                <ul class="mt-10">
                    ...
                    <li class="flex w-full justify-between items-center mb-6">
                        <a href="/category/{{ $postCategory->category }}">
                            <span class="text-sm ml-2 uppercase text-gray-800 hover:text-gray-500 dark:text-white dark:focus:text-white dark:hover:text-gray-200">{{ $postCategory->category }}</span>
                        </a>
        ...
        <div class="w-64 z-40 absolute dark:bg-gray-800 bg-yellow-300 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
            ...
            <div class="">
                <div class="px-6 w-full">
                    <div class="w-full py-5">
                        <div class="text-lg">Blog Post</div>
                        <div class="pt-2 text-red-500 text-right text-lg">- Categories</div>
                    </div>
                    <ul class="mt-10">
                        @foreach($postCategories as $postCategory)
                        <li class="flex w-full justify-between text-gray-800 hover:text-gray-500 items-center mb-6">
                            <a href="/category/{{ $postCategory->category }}">
